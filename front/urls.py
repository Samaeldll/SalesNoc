...
urlpatterns = [
    ...
    path('contract/list/new', views.contract_list, name="contract_list"),
    ...
    path('contract/list/delayed/', views.contract_list_by_status, name="contract_list_by_status"),
    ...
    path('contract/<int:contract_id>/close/', views.contract_return, name='contract_return'),
    ...
    path('contract/<int:contract_id>/waitprocess', views.contract_return, name='contract_return'),
    path('contract/<int:contract_id>/waitclient', views.contract_not_contact, name='contract_not_contact'),
    # path('contract/<int:contract_id>/waitcompany', views.contract_not_contact, name='contract_not_contact'),
    # path('contract/<int:contract_id>/incorrect', views.contract_not_contact, name='contract_not_contact'),
    # path('contract/<int:contract_id>/notconnect', views.contract_not_contact, name='contract_not_contact'),
    # path('contract/<int:contract_id>/complete', views.contract_not_contact, name='contract_not_contact'),
