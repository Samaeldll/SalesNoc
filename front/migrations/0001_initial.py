# Generated by Django 3.2.8 on 2022-08-22 12:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_first', models.SmallIntegerField(choices=[(1, 'HOME в Многокварт.'), (2, 'GPON в Многокварт.'), (3, 'GPON в Частный'), (4, 'Radio в Частный'), (5, 'Индивидуальное')], default=0, verbose_name='Тип подключения интернет')),
                ...
                ('priority_service', models.CharField(choices=[(1, 'Интернет'), (2, 'Телевиденье')], default='SERVICE_A', max_length=15, verbose_name='Приоритетная Услуга')),
                ('create_date', models.DateTimeField(auto_now_add=True)),
